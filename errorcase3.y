...
command :  newline	
	...
	| html_list {printf(" endlist\n");}
	| command html_list newline{printf(" ye\n");}
...
html_list: open_tag close_tag mulline tokens end_tag IDENT close_tag {;} 
	...
	| html_statements newline {;}
	| html_list newline html_statement {;}
...
html_statement: open_tag close_tag html_contents end_tag IDENT close_tag {printf(", ");} 
	| open_tag close_tag html_statement end_tag IDENT close_tag {printf(" nested ");}	
	| html_statement open_tag close_tag html_contents end_tag IDENT close_tag {printf(", ");} 
	;
