...
%type <str> word openB closeB t_OP openP closeP t_openP t_closeP html_statement html_contents html_list 
...
digit: INTEGER {$$ = $1; $$.type = $1.type; }
	| FLOAT {$$ = $1; $$.type = $1.type;}
	| MINUS INTEGER {$$.ival = -$2.ival; $$.type = $2.type;}
	| MINUS FLOAT {$$.fval = -$2.fval; $$.type = $2.type;}
